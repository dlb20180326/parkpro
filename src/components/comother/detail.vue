<template>
	<div style="height:100%;">
		<view-box ref="viewBox" body-padding-top=".46rem">
			...
			<div class="line-pic">
				<img src="../../assets/images/icon-head.png" class="pic-tb" />
				
				<img src="../../assets/images/icon-more.png" class="pic-d">
			</div>
			<p class="allPic">
			...
			<div class="wz-fonts">
				王俊凯 李薇薇 维吾尔 王俊凯 李薇薇 维吾尔 王俊凯 李薇薇 维吾尔 王俊凯 李薇薇 维吾尔 王俊凯 李薇薇 维吾尔
			</div>
	 	</view-box>
	</div>
</template>
